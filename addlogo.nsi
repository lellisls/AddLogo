...
;General
  ...
  ;Name and file
  !define MUI_PRODUCT "Add Logo"
  !define MUI_FILE "addlogo"
  ...
  !define COMPANYNAME "AddLogo"
  !define DESCRIPTION "Add logo é um programa simples para adicionar logotipos em imagens."

  !define BUILD_DIR "C:\Build\build-AddLogo-Desktop_Qt_5_5_1_MinGW_32bit-Release\release"
  CRCCheck On
  Name "${MUI_PRODUCT}"
  Icon "logo.ico"
  # These will be displayed by the "Click here for support information" link in "Add/Remove Programs"
  # It is possible to use "mailto:" links in here to open the email client
  !define HELPURL "https://github.com/lellisls/AddLogo/issues" # "Support Information" link
  !define UPDATEURL "https://github.com/lellisls/AddLogo" # "Product Updates" link
  !define ABOUTURL "https://github.com/lellisls/AddLogo" # "Publisher" link
  # This is the size (in kB) of all the files copied into "Program Files"
  !define INSTALLSIZE 45260
...
;--------------------------------
;Installer Sections
Section "Add Logo" Installationinfo
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_InstInfo ${LANG_ENGLISH} "Install Add Logo."
